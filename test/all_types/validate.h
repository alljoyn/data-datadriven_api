...
void validateInvalidate(const std::shared_ptr<AllTypesProxy>& atp,
                        size_t nelem,
                        long long cnt_val);
...
void validateInvalidate(const std::shared_ptr<AllArraysProxy>& aap,
                        size_t nelem,
                        long long cnt_val);
...
void validateInvalidate(const std::shared_ptr<AllDictionariesProxy>& aap,
                        size_t nelem,
                        long long cnt_val);
