...
#ifndef _OS_DATADRIVEN_CONDITION_H
#define _OS_DATADRIVEN_CONDITION_H
...
class Condition {
  public:
     ...
     */
    QStatus Wait(datadriven::Mutex& m);
     ...
     * @return ER_OK if successful; otherwise an error.
     */
    QStatus TimedWait(datadriven::Mutex& m,
                      uint32_t ms);
...
#endif // _OS_DATADRIVEN_CONDITION_H
