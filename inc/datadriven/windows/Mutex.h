 ...
 ******************************************************************************/
#ifndef _OS_DATADRIVEN_MUTEX_H
#define _OS_DATADRIVEN_MUTEX_H
...
class Mutex {
  public:
     ...
     *  - #ER_OS_ERROR if the underlying OS reports an error.
     */
    QStatus Unlock(const char* file,
                   uint32_t line);
  ...
  private:
     ...
     * section so it can get the private CRITICAL_SECTION out of a datadriven::Mutex
